...
public class AppointmentService {
    ...
    public boolean deleteAppointment(int appointmentId) {
        try {
            ...
            return appointments.removeIf(a -> a != null && a.getAppointmentId() == appointmentId);
    ...
    public boolean toggleAppointmentStatus(int appointmentId) {
        try {
            ...
            if ("ACTIVE".equalsIgnoreCase(appointment.getStatus().name())) {
                appointment.setStatus(Appointment.Status.CANCELLED);
            } else {
                appointment.setStatus(Appointment.Status.ACTIVE);
            }
