...
-- Admin par défaut
INSERT INTO user (role, username, password, first_name, last_name, name, email, admin_id)
VALUES ('admin', 'admin', 'admin123', 'Admin', 'User', 'Admin User', 'admin@patientportal.com', 1);

-- Médecin de test
INSERT INTO user (role, username, password, first_name, last_name, name, email, doctor_id)
VALUES ('doctor', 'jack123', 'pass123', 'Jack', 'Smith', 'Jack Smith', 'jack123@gmail.com', 1);

-- Patient de test
INSERT INTO user (role, username, password, first_name, last_name, name, email, patient_id)
